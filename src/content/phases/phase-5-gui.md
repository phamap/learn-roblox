...
**Предыдущая фаза:** [Фаза 4: Чекпоинты и респавн](./phase-4-checkpoints/)
...
Готов к следующей фазе? → **[Фаза 5.5: RemoteEvent — клиент-сервер](./phase-5-5-remote/)**
...
*Фаза 5 из [плана обучения](../../). Предыдущая: [Фаза 4](./phase-4-checkpoints/) | Следующая: [Фаза 5.5](./phase-5-5-remote/)*
