...
**Предыдущая фаза:** [Фаза 3: TweenService — движение платформ](./phase-3-tween/)
...
Готов к следующей фазе? → **[Фаза 5: GUI — интерфейс](./phase-5-gui/)**
...
*Фаза 4 из [плана обучения](../../). Предыдущая: [Фаза 3](./phase-3-tween/) | Следующая: [Фаза 5](./phase-5-gui/)*
