...
**Предыдущая фаза:** [Фаза 5.5: RemoteEvent — клиент-сервер](./phase-5-5-remote/)
...
*Фаза 6 из [плана обучения](../../). Предыдущая: [Фаза 5.5](./phase-5-5-remote/) | Следующая: [Фаза 7](./phase-7-polish/)*
