...
**Предыдущая фаза:** [Фаза 7: Полировка — звук, свет, декор](./phase-7-polish/)
...
Готов к финалу? → **[Фаза 8: Публикация — выложи игру!](./phase-8-publish/)**
...
*Фаза 7.5 из [плана обучения](../../). Предыдущая: [Фаза 7](./phase-7-polish/) | Следующая: [Фаза 8](./phase-8-publish/)*
