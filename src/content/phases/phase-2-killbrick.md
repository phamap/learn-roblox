...
**Предыдущая фаза:** [Фаза 1: Знакомство с Studio](./phase-1-studio/)
...
Готов к следующей фазе? → **[Фаза 3: TweenService — движение платформ](./phase-3-tween/)**
...
*Фаза 2 из [плана обучения](../../). Предыдущая: [Фаза 1](./phase-1-studio/) | Следующая: [Фаза 3](./phase-3-tween/)*
