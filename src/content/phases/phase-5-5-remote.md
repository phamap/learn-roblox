...
**Предыдущая фаза:** [Фаза 5: GUI — интерфейс](./phase-5-gui/)
...
Готов к следующей фазе? → **[Фаза 6: DataStore — сохранение данных](./phase-6-datastore/)**
...
*Фаза 5.5 из [плана обучения](../../). Предыдущая: [Фаза 5](./phase-5-gui/) | Следующая: [Фаза 6](./phase-6-datastore/)*
