...
**Предыдущая фаза:** [Фаза 2: Kill Brick + Touched](./phase-2-killbrick.md)
...
Готов к следующей фазе? → **[Фаза 4: Чекпоинты и респавн](./phase-4-checkpoints.md)**
...
*Фаза 3 из [плана обучения](../roblox-learning-plan.md). Предыдущая: [Фаза 2](./phase-2-killbrick.md) | Следующая: [Фаза 4](./phase-4-checkpoints.md)*
