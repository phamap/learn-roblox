...
**Лимиты Roblox:**
- Максимум ~20,000 Part'ов для стабильных 60 FPS
...
> **Важно:** StreamingEnabled может сломать скрипты которые обращаются к объектам далеко от игрока. Используй `WaitForChild()` и проверяй существование.
...
- [ ] Services кэшированы
- [ ] Нет密集ных вычислений в Heartbeat
...
- [ ] На Collision Groups для оптимизации физики
