...
**Предыдущая фаза:** [Фаза 6: DataStore — сохранение данных](./phase-6-datastore.md)
...
Готов к следующей фазе? → **[Фаза 7.5: Оптимизация производительности](./phase-7-5-optimization.md)**
...
*Фаза 7 из [плана обучения](../roblox-learning-plan.md). Предыдущая: [Фаза 6](./phase-6-datastore.md) | Следующая: [Фаза 7.5](./phase-7-5-optimization.md)*
